...
import {
  captureTraceParent,
  captureTraceParentFromPerformanceEntries,
} from '../src/servertiming';
...
describe('test captureTraceParent', () => {
  it('should deal with simple value', () => {
    ...
    captureTraceParent(
      'traceparent;desc="00-000000000000000078499d3266d75d5f-7e1c10b3c482edbe-01"',
      span as any,
    );
    assert.strictEqual(
      '000000000000000078499d3266d75d5f',
      span['link.traceId'],
    );
    ...
    const entries = {
      serverTiming: [
        { name: 'nomatch' },
        {
          name: 'traceparent',
          description:
            '00-000000000000000078499d3266d75d5f-7e1c10b3c482edbe-01',
        },
      ],
    };
    const span = {
