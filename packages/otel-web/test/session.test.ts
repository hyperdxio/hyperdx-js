...
describe('Session tracking', () => {
  it('should correctly handle expiry, garbage values, (in)activity, etc.', (done) => {
    ...
    document.cookie =
      COOKIE_NAME + '=garbageValue;expires=Thu, 01 Jan 1970 00:00:00 GMT';
    ...
    const cookieValue = encodeURIComponent(
      JSON.stringify({ id: firstSessionId, startTime: new Date().getTime() }),
    );
    document.cookie =
      COOKIE_NAME + '=' + cookieValue + '; path=/; max-age=' + 2;
    ...
    setTimeout(() => {
      ...
      document.cookie =
        COOKIE_NAME + '=' + tooOldCookieValue + '; path=/; max-age=' + 4;
